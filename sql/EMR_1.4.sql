...
(2, 2, 1, 'john doe', 1, 'milk xue', 1, 'milk xue', 'PHYSICIAN', '2015-03-31', ''),
(3, 3, 1, 'john doe', 1, 'milk xue', 1, 'Kasi Periyasamy', 'MEDICAL_STAFF', '2015-03-31', ''),
(4, 4, 1, 'john doe', 1, 'milk xue', 1, 'milk xue', 'PHYSICIAN', '2015-03-31', ''),
(5, 5, 1, 'john doe', 1, 'milk xue', 1, 'milk xue', 'PHYSICIAN', '2015-04-13', '');
...
(1, 2, 11, 'Abdominoplasty (Tummy Tuck ( Abdominoplasty))'),
(2, 3, 11, 'Abdominoplasty (Tummy Tuck ( Abdominoplasty))'),
(3, 4, 11, 'Abdominoplasty (Tummy Tuck ( Abdominoplasty))'),
(4, 5, 11, 'Abdominoplasty (Tummy Tuck ( Abdominoplasty))');
...
(1, 2, 4, 'ONLY CAN BE DONE BY PHYSICIAN', 1, 'milk xue', 'PHYSICIAN'),
(2, 3, 2, 'put needle', 1, 'Kasi Periyasamy', 'MEDICAL_STAFF'),
(3, 3, 3, 'check blood pressure', 1, 'Kasi Periyasamy', 'MEDICAL_STAFF'),
(4, 4, 2, 'put needle', 1, 'milk xue', 'PHYSICIAN'),
(5, 5, 2, 'put needle', 1, 'milk xue', 'PHYSICIAN');
...
(2, 13, 1, 'john doe', 'test', 'test', 1, 'milk xue', 1, 'milk xue', 'PHYSICIAN', '2015-03-31'),
(3, 13, 1, 'john doe', 'test', 'test', 1, 'milk xue', 1, 'Kasi Periyasamy', 'MEDICAL_STAFF', '2015-03-31'),
(4, 13, 1, 'john doe', 'Test la', 'La', 1, 'milk xue', 1, 'milk xue', 'PHYSICIAN', '2015-03-31'),
(5, 13, 1, 'john doe', '', '', 1, 'milk xue', 1, 'milk xue', 'PHYSICIAN', '2015-04-13');
